...
data_id = '/beegfs/home/zhangxin/content/LapH/run/beta6.41_mu-0.2320_ms-0.2050_L32x64/contraction_run/PionKaon_run/P000/eff_mass_p000_uu'
...
plt.errorbar(time,mass_bar,yerr = jack_error,marker = '.',linestyle = 'none')
plt.ylim(0.06,0.15)
plt.xlabel('time')
plt.ylabel('eff_mass')
plt.show()
