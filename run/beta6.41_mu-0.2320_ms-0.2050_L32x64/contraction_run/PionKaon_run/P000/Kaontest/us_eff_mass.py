...
kaon_id = '/beegfs/group/lqcd/corr/beta6.41_mu-0.2320_ms-0.2050_L32x64/2pt/Kaon'
for fid in range(100):
    infile = fileinput.input('%s/corr_us_gamma5_Px0Py0Pz0_conf%05d.dat'%(kaon_id,13500+fid*50))
    flist = []
