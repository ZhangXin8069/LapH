...
write_data_ascii(corr_pion, Nt, Nx, "/beegfs/home/zhangxin/content/LapH/contraction_code/corr_uu_gamma5_Px0Py0Pz0_conf%s.%s.dat"%( conf_id,nanu))
write_data_ascii(corr_kaon, Nt, Nx, "/beegfs/home/zhangxin/content/LapH/contraction_code/corr_us_gamma5_Px0Py0Pz0_conf%s.%s.dat"%( conf_id,nanu))	
